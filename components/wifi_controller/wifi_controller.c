 ...
 *        Memilih satu dari 100 array OUI resmi Huawei secara acak, 
...
void wifictl_set_vendor_huawei_random_mac() {
    ...
    // Array Statis 100 OUI MAC Prefix Resmi Huawei Technologies Co., Ltd.
    static const uint8_t huawei_ouis[100][3] = {
    ...
    if (esp_wifi_get_mac(WIFI_IF_AP, current_mac) == ESP_OK) {
        ...
        // 2. Pilih salah satu dari 100 Prefix OUI Huawei secara acak
