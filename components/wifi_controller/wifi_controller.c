...
void wifictl_set_vendor_huawei_random_mac() {
    ...
    // Array Statis 200 OUI MAC Prefix Resmi Huawei Technologies Co., Ltd.
    static const uint8_t huawei_ouis[200][3] = {
        // Blok 1
        {0x00, 0xE0, 0xFC}, {0x28, 0x6E, 0xD4}, {0xA4, 0xB1, 0xE9}, {0xCC, 0xA2, 0x23}, {0x3C, 0xF8, 0x08},
        {0x40, 0x4D, 0x7E}, {0x54, 0x89, 0x98}, {0x70, 0x72, 0x3C}, {0x00, 0x18, 0x82}, {0x00, 0x1E, 0x10},
        {0x00, 0x25, 0x9E}, {0x00, 0x46, 0x4B}, {0x04, 0xBD, 0x70}, {0x08, 0x19, 0xA6}, {0x0C, 0x37, 0xDC},
        {0x0C, 0x45, 0xBA}, {0x0C, 0x96, 0xBF}, {0x10, 0x1B, 0x54}, {0x10, 0x47, 0x80}, {0x10, 0x51, 0x72},
        {0x10, 0xC6, 0x1F}, {0x14, 0xB9, 0x68}, {0x18, 0xC5, 0x8A}, {0x1C, 0x1D, 0x86}, {0x20, 0x08, 0xED},
        {0x20, 0x2B, 0xC1}, {0x20, 0xF3, 0xA3}, {0x24, 0x09, 0x95}, {0x24, 0x69, 0x68}, {0x28, 0x3C, 0xE4},
        {0x2C, 0x9D, 0x1E}, {0x30, 0xF5, 0x36}, {0x34, 0x00, 0xA3}, {0x34, 0x6A, 0xC2}, {0x38, 0xF8, 0x89},
        {0x3C, 0xDF, 0xBD}, {0x40, 0x4D, 0x8E}, {0x44, 0x55, 0xB1}, {0x48, 0x46, 0xFB}, {0x48, 0x62, 0x76},
        {0x4C, 0x1F, 0xCC}, {0x4C, 0x54, 0x99}, {0x4C, 0xB1, 0x6C}, {0x50, 0x9F, 0x27}, {0x54, 0xA5, 0x1B},
        ...
        // Blok 3
        {0x00, 0x9A, 0xCD}, {0x00, 0xB8, 0xC2}, {0x00, 0xC8, 0x8B}, {0x00, 0xCD, 0xFE}, {0x00, 0xDB, 0x70}, 
        {0x04, 0xC0, 0x6F}, {0x04, 0xF9, 0x38}, {0x08, 0x4F, 0x0A}, {0x08, 0x63, 0xF4}, {0x08, 0x7A, 0x4C}, 
        {0x08, 0xC6, 0xB3}, {0x0C, 0x11, 0x67}, {0x0C, 0x70, 0x4A}, {0x0C, 0xB5, 0x27}, {0x14, 0xD0, 0x0D}, 
        {0x18, 0x02, 0x2D}, {0x18, 0x3D, 0x5E}, {0x1C, 0x59, 0x9B}, {0x1C, 0x8E, 0x5C}, {0x24, 0x7E, 0x12}, 
        {0x28, 0x5F, 0xDB}, {0x2C, 0xAB, 0x00}, {0x34, 0x2E, 0xB7}, {0x38, 0x4C, 0x4F}, {0x40, 0xCB, 0xA8}, 
        {0x48, 0x8E, 0xEF}, {0x58, 0x60, 0x5F}, {0x5C, 0xB3, 0x95}, {0x60, 0xE7, 0x01}, {0x6C, 0xB7, 0x49}, 
        {0x78, 0xF5, 0xFD}, {0x80, 0x71, 0x7A}, {0x80, 0xFB, 0x06}, {0x8C, 0xE5, 0x83}, {0x90, 0x67, 0x1C}, 
        {0x9C, 0x52, 0xF8}, {0xA4, 0x99, 0x47}, {0xA8, 0xC8, 0x3A}, {0xAC, 0x75, 0x1D}, {0xAC, 0xE2, 0x15}, 
        {0xAC, 0xF7, 0xF3}, {0xB0, 0x89, 0x00}, {0xB4, 0x43, 0x0D}, {0xB4, 0xC7, 0x99}, {0xB8, 0x08, 0xCF}, 
        {0xBC, 0x25, 0xE0}, {0xBC, 0x3A, 0xEA}, {0xC0, 0x70, 0x09}, {0xC4, 0x07, 0x2F}, {0xC4, 0x86, 0xE9}, 
        // Blok 4
        {0xC4, 0xB8, 0xB4}, {0xC8, 0x8D, 0x83}, {0xCC, 0x96, 0xA0}, {0xCC, 0xAE, 0x50}, {0xD0, 0x16, 0xB4}, 
        {0xD0, 0x3E, 0x5C}, {0xD0, 0x5B, 0xA8}, {0xD4, 0x40, 0xF0}, {0xD4, 0x6A, 0xA8}, {0xD4, 0x9A, 0x20}, 
        {0xD4, 0x9E, 0x3B}, {0xD4, 0xB1, 0x10}, {0xD8, 0x49, 0x0B}, {0xD8, 0x50, 0xE6}, {0xDC, 0xD2, 0xFC}, 
        {0xE0, 0x24, 0x81}, {0xE0, 0x97, 0x96}, {0xE0, 0xCC, 0x7A}, {0xE4, 0x54, 0xE8}, {0xE4, 0x68, 0xA3}, 
        {0xE4, 0xCA, 0x12}, {0xE8, 0x08, 0x8B}, {0xE8, 0xBD, 0xD1}, {0xE8, 0xCD, 0x2D}, {0xEC, 0x23, 0x3D}, 
        {0xEC, 0xCB, 0x30}, {0xEC, 0xCD, 0x6D}, {0xF0, 0x63, 0xF9}, {0xF4, 0x55, 0x9C}, {0xF4, 0xC7, 0x14}, 
        {0xF8, 0x01, 0x13}, {0xF8, 0x3D, 0xFF}, {0xF8, 0x4A, 0xBF}, {0xF8, 0xE8, 0x11}, {0xFC, 0x48, 0xEF}, 
        {0xFC, 0xE3, 0x3C}, {0x00, 0x4D, 0x4B}, {0x08, 0x1F, 0x71}, {0x0C, 0x96, 0xBF}, {0x14, 0xA3, 0x2F}, 
        {0x18, 0x9D, 0x5B}, {0x20, 0x0B, 0xC7}, {0x28, 0x6F, 0x7F}, {0x30, 0x45, 0x11}, {0x38, 0xBC, 0x1A}, 
        {0x40, 0xCB, 0x8A}, {0x4C, 0xB1, 0x6C}, {0x50, 0x9F, 0x27}, {0x54, 0x89, 0x98}, {0x60, 0xDE, 0x44}
    };
