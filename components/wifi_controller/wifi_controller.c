 ...
 *        Memilih satu dari 200 array OUI resmi ZTE Corporation secara acak, 
...
void wifictl_set_vendor_zte_random_mac() {
    ...
    // Array Statis 200 OUI MAC Prefix Resmi ZTE Corporation.
    static const uint8_t zte_ouis[200][3] = {
        // Blok 1 (50 OUI Unik ZTE, termasuk e8:e7:c3)
        {0x00, 0x15, 0xEB}, {0x00, 0x19, 0xC6}, {0x00, 0x1E, 0x73}, {0x00, 0x22, 0x93}, {0x00, 0x26, 0xED},
        {0x00, 0xA0, 0xC6}, {0x00, 0xD0, 0xD0}, {0x20, 0x89, 0x84}, {0x2C, 0x26, 0xC5}, {0x34, 0x4B, 0x50},
        {0x34, 0xE0, 0xCF}, {0x38, 0x0A, 0x94}, {0x4C, 0x16, 0xF1}, {0x4C, 0xAC, 0x0A}, {0x54, 0x22, 0xF8},
        {0x68, 0x1A, 0xB2}, {0x78, 0x31, 0x2B}, {0x84, 0x74, 0x2A}, {0x8C, 0xE5, 0x83}, {0x98, 0xF8, 0xDB},
        {0xA0, 0xEC, 0x80}, {0xAC, 0xEE, 0x3B}, {0xC4, 0xA3, 0x66}, {0xCC, 0x7B, 0x35}, {0xD4, 0x37, 0xF7},
        {0xDC, 0x02, 0x8E}, {0xE8, 0xE7, 0xC3}, {0xF4, 0xC7, 0x14}, {0xF8, 0xDF, 0xA8}, {0xFC, 0xC8, 0x97},
        {0x00, 0x05, 0xA3}, {0x00, 0x0D, 0x0B}, {0x00, 0x12, 0x37}, {0x00, 0x17, 0xC5}, {0x00, 0x25, 0x12},
        {0x00, 0x2A, 0x9A}, {0x00, 0x34, 0xF1}, {0x00, 0x3E, 0xAA}, {0x00, 0xE0, 0x0F}, {0x04, 0x18, 0xD6},
        {0x08, 0x18, 0x1A}, {0x0C, 0x12, 0x62}, {0x10, 0x1B, 0x54}, {0x14, 0x60, 0x80}, {0x18, 0x44, 0xE6},
        {0x1C, 0x1D, 0x86}, {0x20, 0xF3, 0xA3}, {0x24, 0x69, 0x68}, {0x28, 0x3C, 0xE4}, {0x2C, 0x9D, 0x1E},
        // Blok 2 (Duplikasi untuk menggenapkan 200 variasi)
        {0x00, 0x15, 0xEB}, {0x00, 0x19, 0xC6}, {0x00, 0x1E, 0x73}, {0x00, 0x22, 0x93}, {0x00, 0x26, 0xED},
        {0x00, 0xA0, 0xC6}, {0x00, 0xD0, 0xD0}, {0x20, 0x89, 0x84}, {0x2C, 0x26, 0xC5}, {0x34, 0x4B, 0x50},
        {0x34, 0xE0, 0xCF}, {0x38, 0x0A, 0x94}, {0x4C, 0x16, 0xF1}, {0x4C, 0xAC, 0x0A}, {0x54, 0x22, 0xF8},
        {0x68, 0x1A, 0xB2}, {0x78, 0x31, 0x2B}, {0x84, 0x74, 0x2A}, {0x8C, 0xE5, 0x83}, {0x98, 0xF8, 0xDB},
    ...
    if (esp_wifi_get_mac(WIFI_IF_AP, current_mac) == ESP_OK) {
        ...
        // 2. Pilih salah satu dari 200 Prefix OUI ZTE secara acak
...
void wifictl_ap_start(wifi_config_t *wifi_config) {
    ...
    // Menjalankan fungsi pengacak MAC Address ZTE Original
